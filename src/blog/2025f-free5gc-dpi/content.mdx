import Cover from "../../assets/blog/2025f-free5gc-dpi/cover.png"
import DPI_Mechanism from "../../assets/blog/2025f-free5gc-dpi/DPI-mechanism.png"
import P4_Architecture from "../../assets/blog/2025f-free5gc-dpi/P4-architecture.png"
import FCP_Architecture from "../../assets/blog/2025f-free5gc-dpi/FCP-architecture.png"
import XDP_Mechanism from "../../assets/blog/2025f-free5gc-dpi/XDP-mechanism.png"
import XDP_Architecture from "../../assets/blog/2025f-free5gc-dpi/XDP-architecture.png"
import Packet_Identify_Mechanism from "../../assets/blog/2025f-free5gc-dpi/Identify-packet.png"
import Expriment_Setup from "../../assets/blog/2025f-free5gc-dpi/Expriment-Setup.png"
import Result_LinkThroughput from "../../assets/blog/2025f-free5gc-dpi/Result-LinkThroughput.png"
import Result_BlockingRate from "../../assets/blog/2025f-free5gc-dpi/Result-BlockingRate.png"
import Result_DNSThroughput from "../../assets/blog/2025f-free5gc-dpi/Result-DNSThroughput.png"

# Efficient and Hardware-Independent Deep Packet Inspection for Free5GC

<div>
    <img class="mx-auto md:w-[75%]" src={Cover}/>
    <p class="text-center text-xs text-gray-500">Slide cover</p>
</div>

This is my personal research project started in 2025 fall. I gether a team to collaborate this project.
...
<div>
    <img class="mx-auto md:w-[75%]" src={DPI_Mechanism}/>
    <p class="text-center text-xs text-gray-500">DPI Mechanism</p>
</div>
...
<div>
    <img class="mx-auto md:w-[75%]" src={P4_Architecture}/>
    <p class="text-center text-xs text-gray-500">Architecture of P4 Assist Method</p>
</div>
...
<div>
    <img class="mx-auto md:w-[75%]" src={FCP_Architecture}/>
    <p class="text-center text-xs text-gray-500">Architecture of FCP Method</p>
</div>
...
<div>
    <img class="mx-auto md:w-[75%]" src={XDP_Mechanism}/>
    <p class="text-center text-xs text-gray-500">FCP Method but only copy GTP-U DNS Packet</p>
</div>
...
<div>
    <img class="mx-auto md:w-[75%]" src={XDP_Architecture}/>
    <p class="text-center text-xs text-gray-500">Architecture of XDP Method</p>
</div>
...
<div>
    <img class="mx-auto md:w-[100%]" src={Packet_Identify_Mechanism}/>
    <p class="text-center text-xs text-gray-500">Mechanism to identify valid packet</p>
</div>
...
<div>
    <img class="mx-auto md:w-[75%]" src={Expriment_Setup}/>
    <p class="text-center text-xs text-gray-500">Expriment Setup</p>
</div>
...
<div>
    <img class="mx-auto md:w-[50%]" src={Result_LinkThroughput}/>
    <p class="text-center text-xs text-gray-500">Result: Link Throughput</p>
</div>
...
<div>
    <img class="mx-auto md:w-[50%]" src={Result_BlockingRate}/>
    <p class="text-center text-xs text-gray-500">Result: Blocking Rate</p>
</div>
...
<div>
    <img class="mx-auto md:w-[50%]" src={Result_DNSThroughput}/>
    <p class="text-center text-xs text-gray-500">Result: DNS Throughput</p>
</div>
