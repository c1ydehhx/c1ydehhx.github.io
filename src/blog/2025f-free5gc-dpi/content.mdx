...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/cover.png"/>
    <p className="text-center text-xs text-gray-500">Slide cover</p>
</div>
...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/DPI-mechanism.png"/>
    <p className="text-center text-xs text-gray-500">DPI Mechanism</p>
</div>
...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/P4-architecture.png"/>
    <p className="text-center text-xs text-gray-500">Architecture of P4 Assist Method</p>
</div>
...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/FCP-architecture.png"/>
    <p className="text-center text-xs text-gray-500">Architecture of FCP Method</p>
</div>
...
### Key Idea: Is it possible to classNameify packet on kernel space?
...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/XDP-mechanism.png"/>
    <p className="text-center text-xs text-gray-500">FCP Method but only copy GTP-U DNS Packet</p>
</div>
...
It achieve the packet classNameify on kernel space, and we can copy the packet we interest only.

Therefore, we can deploy this solution to achieve DPI.

<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/XDP-architecture.png"/>
    <p className="text-center text-xs text-gray-500">Architecture of XDP Method</p>
</div>
...
<div>
    <img className="mx-auto md:w-[100%]" src="/image/blog/2025f-free5gc-dpi/Identify-packet.png"/>
    <p className="text-center text-xs text-gray-500">Mechanism to identify valid packet</p>
</div>
...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-free5gc-dpi/Expriment-Setup.png"/>
    <p className="text-center text-xs text-gray-500">Expriment Setup</p>
</div>
...
<div>
    <img className="mx-auto md:w-[50%]" src="/image/blog/2025f-free5gc-dpi/Result-LinkThroughput.png"/>
    <p className="text-center text-xs text-gray-500">Result: Link Throughput</p>
</div>
...
<div>
    <img className="mx-auto md:w-[50%]" src="/image/blog/2025f-free5gc-dpi/Result-BlockingRate.png"/>
    <p className="text-center text-xs text-gray-500">Result: Blocking Rate</p>
</div>
...
<div>
    <img className="mx-auto md:w-[50%]" src="/image/blog/2025f-free5gc-dpi/Result-DNSThroughput.png"/>
    <p className="text-center text-xs text-gray-500">Result: DNS Throughput</p>
</div>
