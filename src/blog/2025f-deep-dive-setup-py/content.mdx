...
<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-deep-dive-setup-py/cover.png"/>
    <p className="text-center text-xs text-gray-500">CI is broken</p>
</div>
...
Finally, we fix the issue by not taken any method I purpose in previous. By modify `MANIFEST.in`, it fix the issue and only caused less than 10 lines diff. 

Now it works.

<div>
    <img className="mx-auto md:w-[75%]" src="/image/blog/2025f-deep-dive-setup-py/works.png"/>
    <p className="text-center text-xs text-gray-500">Now it works</p>
</div>
